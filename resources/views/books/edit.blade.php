        ...
        <div class="mb-md-4 mt-md-4 pb-1">
            ...
            <div class="form-outline form-white mb-4 text-start">
                ...
                <input type="number" name="pages" class="form-control @error('pages') is-invalid @enderror"
                    id="password_confirmation" placeholder="0-9" value="{{ $book->pages }}" />
                @error('pages')
                    {{ $message }}
                @enderror
            </div>
            ...
            <div class="form-outline form-white mb-4 text-start">
                ...
                <input type="textarea" id="description"
                    ...
                    placeholder="Descrizione del libro" name="description" value="{{ $book->description }}" />
                @error('description')
                    {{ $message }}
                @enderror
            </div>
            ...
            <div class="form-outline form-white mb-4 text-start">
                ...
                <input type="number" name="price" min="1"
                    ...
                    required placeholder="0-9€" value="{{ $book->price }}" />
                @error('price')
                    {{ $message }}
                @enderror
            </div>
