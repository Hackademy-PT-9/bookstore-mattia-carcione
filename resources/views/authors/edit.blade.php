        ...
        <div class="mb-md-4 mt-md-4 pb-1">
            ...
            <div class="form-outline form-white mb-4 text-start">
                ...
                <input type="text" id="firstname"
                    ...
                    placeholder="Nome dell'autore" name="firstname" required value="{{ $author->firstname }}" />
                @error('firstname')
                    {{ $message }}
                @enderror
            </div>
            ...
            <div class="form-outline form-white mb-4 text-start">
                ...
                <input type="text" id="lastname"
                    ...
                    placeholder="Cognome dell'autore" name="lastname" required value="{{ $author->lastname }}" />
                @error('lastname')
                    {{ $message }}
                @enderror
            </div>
